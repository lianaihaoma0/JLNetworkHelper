...
typedef NS_ENUM(NSUInteger, JLNetworkStatus) {
    /// 未知网络
    JLNetworkStatusUnknown,
    /// 无网络
    JLNetworkStatusNotReachable,
    /// 手机网络
    JLNetworkStatusReachableViaWWAN,
    /// WIFI网络
    JLNetworkStatusReachableViaWiFi
};
...
/// 网络状态的Block
typedef void (^NetworkStatus)(JLNetworkStatus status);

@interface JLNetworkHelper : NSObject
/// 开始监听网络状态
